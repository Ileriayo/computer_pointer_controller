...
class Visualizer:
    ...
    def visualize(self):
        if self.fd_coords == []:
            ...
            cv2.putText(self.fd_img, 'Yaw: {:.3f}'.format(self.hpe_val[0]) , (2, 15), cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
            cv2.putText(self.fd_img, 'Pitch: {:.3f}'.format(self.hpe_val[1]) , (2, 30), cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
            cv2.putText(self.fd_img, 'Roll: {:.3f}'.format(self.hpe_val[2]) , (2, 45), cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
